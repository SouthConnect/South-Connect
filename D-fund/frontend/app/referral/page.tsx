  ...
  if (!user) {
    return (
      <div className="container mx-auto px-6 py-12 max-w-5xl text-center">
        <p className="text-gray-500 mb-4">Sign in to access your referral program.</p>
        <Link href="/login" className="px-6 py-2 bg-[#3b49df] text-white rounded-lg font-semibold hover:bg-[#2d3aba]">
          Sign In
        </Link>
      </div>
    )
